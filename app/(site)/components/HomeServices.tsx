        ...
        <div className={`grid gap-6 lg:grid-cols-${data.length}`}>
          {data.map((service: any) => (
            <Link
              ...
              className="sm:text-center max-w-[300px] mx-auto hover:scale-110 duration-700 transition-all">
              ...
              <p className="mt-6 inline-flex items-center font-semibold transition-colors duration-200 capitalize text-sm">
